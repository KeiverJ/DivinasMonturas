...
import { FaSun, FaShieldAlt, FaStar, FaGem, FaInstagram } from "react-icons/fa";
  ...
  const collections = [
    {
      ...
      description: "El ícono atemporal que nunca pasa de moda",
    ...
    },
    {
      ...
      description: "Estilo deportivo con máxima funcionalidad",
      image: "https://images.unsplash.com/photo-1473496169904-658ba7c44d8a?w=800",
      price: "Desde $180.000"
    },
    {
      name: "Round Vintage",
      description: "Un toque retro con personalidad moderna",
            ...
            {collections.map((collection, index) => (
              ...
              >
                <div className="relative overflow-hidden rounded-xl mb-4 aspect-square">
                  ...
                  >
                    <button className="px-6 py-3 rounded-lg bg-white text-[#1A628F] font-semibold transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                      Ver Detalles
                    </button>
                  </div>
                </div>
